...
/**
 * RegistrationVoucher Class Doc Comment
 *
 * @category Class
 * @description Eligible vouchers with their contract numbers.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegistrationVoucher implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegistrationVoucher';
    ...
    public function setContractNumber($contract_number)
    {
        if ((mb_strlen($contract_number) > 128)) {
            throw new \InvalidArgumentException('invalid length for $contract_number when calling RegistrationVoucher., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($contract_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract_number when calling RegistrationVoucher., must be bigger than or equal to 1.');
        }
