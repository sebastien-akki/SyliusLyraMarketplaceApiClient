...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function setStreetNumber($street_number)
    {
        if (!is_null($street_number) && (mb_strlen($street_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $street_number when calling Address., must be smaller than or equal to 5.');
        }
    ...
    public function setDistrict($district)
    {
        if (!is_null($district) && (mb_strlen($district) > 127)) {
            throw new \InvalidArgumentException('invalid length for $district when calling Address., must be smaller than or equal to 127.');
        }
    ...
    public function setZipcode($zipcode)
    {
        if (!is_null($zipcode) && (mb_strlen($zipcode) > 64)) {
            throw new \InvalidArgumentException('invalid length for $zipcode when calling Address., must be smaller than or equal to 64.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 128)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Address., must be smaller than or equal to 128.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 127)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Address., must be smaller than or equal to 127.');
        }
