...
/**
 * TransactionCashoutSerializer Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionCashoutSerializer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionCashoutSerializer';
    ...
    public function setTransUuid($trans_uuid)
    {
        if (!is_null($trans_uuid) && (mb_strlen($trans_uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $trans_uuid when calling TransactionCashoutSerializer., must be smaller than or equal to 36.');
        }
    ...
    public function setUuid($uuid)
    {
        ...
        if (!is_null($uuid) && (mb_strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling TransactionCashoutSerializer., must be bigger than or equal to 1.');
        }
